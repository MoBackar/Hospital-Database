...
{
    public partial class VFP : System.Web.UI.Page
    {
        ...
        protected void S_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                SqlCommand viewPatients = new SqlCommand("SELECT * FROM Patient where id=@Patientid", conn);
                viewPatients.Parameters.AddWithValue("@PatientId",patientId);
